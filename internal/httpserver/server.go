...
func (s *Server) routes() {
	...
	protected.POST("/workbench/works/:taskID/voiceover-replacements", s.handleCreateVoiceoverReplacement)
	protected.GET("/workbench/works/:taskID/voiceover-replacements/current", s.handleGetCurrentVoiceoverReplacement)
	protected.POST("/workbench/works/:taskID/voiceover-replacements/:replacementID/apply", s.handleApplyVoiceoverReplacement)
	protected.DELETE("/workbench/works/:taskID/voiceover-replacements/:replacementID", s.handleCancelVoiceoverReplacement)
	...
	protected.GET("/assets/semantic-space", s.handleGetAssetSemanticSpace)
	protected.POST("/assets/semantic-space/query", s.handleQueryAssetSemanticSpace)
	protected.POST("/assets/bulk-archive", s.handleArchiveAssets)
	protected.POST("/assets/bulk-reanalyze", s.handleReanalyzeAssets)
	protected.GET("/assets/:assetID", s.handleGetAsset)
	protected.GET("/assets/:assetID/neighbors", s.handleGetAssetSemanticNeighbors)
	...
	protected.POST("/assets/:assetID/reanalyze", s.handleReanalyzeAsset)
