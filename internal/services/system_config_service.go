...
func defaultSystemConfigs() []SystemConfig {
	return []SystemConfig{
		...
		{Key: "embedding.model", Value: "text-embedding-v4", Type: "string", Description: "Default embedding model"},
		{Key: "embedding.dimension", Value: 1024, Type: "number", Description: "Default embedding vector dimension"},
